# This Makefile is for the Javascript::Select::Chain extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Javascript/Select/Chain.pm]
#     AUTHOR => q[tbrannon <tbrannon@familiehaase.de>]
#     NAME => q[Javascript::Select::Chain]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Javascript/Select/Chain.pm]
...
FULLEXT = Javascript/Select/Chain
BASEEXT = Chain
PARENT_NAME = Javascript::Select
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Javascript/Select/Chain.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Javascript/Select/Chain.pm \
...
INST_LIBDIR      = $(INST_LIB)/Javascript/Select
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Javascript/Select
...
PM_TO_BLIB = lib/Javascript/Select/Chain.pm \
